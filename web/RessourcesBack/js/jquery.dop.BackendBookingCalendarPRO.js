...
(function($){
    $.fn.DOPBackendBookingCalendarPRO = function(options){
        var Data = {'AddtMonthViewText': 'Add Month View', // Add Month View button title (plus icon).
                    ...
                    'DataURL': 'http://127.0.0.1/Bigdeal/trunk/web/app_dev.php/reservation/load', // URL from were JSON data is loaded.
                    ...
                    'DayNames': ['Dimanche', 'Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi'], // Weekdays long names.
                    ...
                    'MonthNames': ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'], // Months long names.
        ...
        CloseLabel = 'Close',
        Currency = '$',
        DataURL = 'http://127.0.0.1/Bigdeal/trunk/web/app_dev.php/reservation/load',
