    ...
    $.fn.DOPFrontendBookingCalendarPRO = function(options){
        ...
        methods = {
                    ...
                    initNavigation:function(){// Init Navigation
                        ...
                        $('.DOPFrontendBookingCalendarPRO_Navigation .previous_btn', Container).bind('click', function(){
                        ...
                        $('.DOPFrontendBookingCalendarPRO_Navigation .next_btn', Container).bind('click', function(){
                            methods.generateCalendar(StartYear, CurrMonth+1);
                        ...
                        $('.DOPFrontendBookingCalendarPRO_Navigation .add_btn', Container).bind('click', function(){
                            noMonths++;
                        ...
                        $('.DOPFrontendBookingCalendarPRO_Navigation .remove_btn', Container).bind('click', function(){
                            noMonths--;
                            methods.generateCalendar(StartYear, CurrMonth);
