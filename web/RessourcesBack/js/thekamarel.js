...
$(function(){
    ...
    var monthNames = [ "Janvier", "Fevrier", "Mars", "Avril", "Mail", "Juin", "Juillet", "Aoutt", "Septembre", "Octobre", "Novembre", "Decembre" ],
...
function confirmCancelbox(url) {
    //e.preventDefault();
    bootbox.confirm("Voulez-vous vraiment annuler ce rembourcemment !!", function (confirmed) {
        if(confirmed){
            $(location).attr('href', url);
        }
    });
